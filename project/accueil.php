...
$reports_data = [
    ...
    [
        "id" => "mt5_auto_learning_engine",
        "title" => "Conception d'un Moteur d'Auto-Apprentissage MT5",
        "url" => "mt5auto.html", // Assurez-vous que ce nom de fichier correspond
        "description" => "Design d'un système adaptatif pour le trading algorithmique sur MT5 avec apprentissage incrémental et boucles de rétroaction."
    ],
    [
        "id" => "xauusd_risk_management",
        "title" => "Gestion Risques & Positions XAU/USD Micro-Lots",
        "url" => "risque.html", // Assurez-vous que ce nom de fichier correspond
        "description" => "Cadre avancé pour la gestion des risques et le dimensionnement des positions pour XAU/USD micro-lots sur un compte de €10k."
    ],
    [
        "id" => "gold_trading_ai_research_plan",
        "title" => "Plan de Recherche : IA pour Scalping XAU/USD",
        "url" => "recherche.html", // Assurez-vous que ce nom de fichier correspond
        "description" => "Cadre technique pour un système IA générant des signaux de trading haute précision pour XAU/USD (scalping/intraday)."
    ],
    [
        "id" => "gold_scalping_ai_assistant",
        "title" => "Conception Assistant IA pour Scalping Or",
        "url" => "assistant.html", // Assurez-vous que ce nom de fichier correspond
        "description" => "Spécification technique d'un assistant IA haute fiabilité pour le scalping manuel de XAU/USD."
    ],
